...
void OBSBasic::StartStreaming()
{
	...
	SaveProject();
	streamingBtn_1->setEnabled(false);
	streamingBtn_1->setText(QTStr("Basic.Main.Connecting"));

	if (sysTrayStream) {
		sysTrayStream->setEnabled(false);
		sysTrayStream->setText(streamingBtn_1->text());
	}

	if (!outputHandler->StartStreaming(service)) {
		streamingBtn_1->setText(QTStr("Basic.Main.StartStreaming"));
		streamingBtn_1->setEnabled(true);
...
{
	streamingBtn_1->setText(QTStr("Basic.Main.StopStreaming"));
	streamingBtn_1->setEnabled(true);
	...
	streamingBtn_1->setMenu(startStreamMenu);
...
{
	streamingBtn_1->setText(QTStr("Basic.Main.StoppingStreaming"));
...
void OBSBasic::StreamingStop(int code, QString last_error)
{
	...
	if (!startStreamMenu.isNull()) {
		streamingBtn_1->setMenu(nullptr);
		startStreamMenu->deleteLater();
...
{
	btnStartRecording->setText(QTStr("Basic.Main.StoppingRecording"));

	if (sysTrayRecord)
		sysTrayRecord->setText(btnStartRecording->text());
...
void OBSBasic::RecordingStart()
{
	...
	btnStartRecording->setText(QTStr("Basic.Main.StopRecording"));
...
void OBSBasic::RecordingStop(int code)
{
	...
	btnStartRecording->setText(QTStr("Basic.Main.StartRecording"));
